...
@Service
public class Daejeon_Seo_AnimalHospitalService implements AnimalHospitalService {
    @Value("${custom.dataGoKr.animalHospitals.daejeon-si.seo-gu.baseUrl}")
    private String baseUrl;

    @Value("${custom.dataGoKr.animalHospitals.daejeon-si.seo-gu.queryString}")
    private String queryString;

    @Value("${custom.dataGoKr.animalHospitals.daejeon-si.seo-gu.apiKey}")
